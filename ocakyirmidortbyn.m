%% Calling ECG Signal
% Open .mat file
srcFiles = dir('C:\Users\huseyinyanik\Desktop\akademik\EKG ÇALIÞMALARI\antrene work\Bayan Sporcu\*.mat');
for kkk=1:length(srcFiles)
% [FileName,PathName] = uigetfile('*.mat','Select mat file');
FileName=srcFiles(kkk).name;
PathName='C:\Users\huseyinyanik\Desktop\akademik\EKG ÇALIÞMALARI\antrene work\Bayan Sporcu';
